...
public class Chance extends Cell{
    ...
    public static void read() {
      try{
          File n=new File("C:\\Users\\misho\\OneDrive\\Desktop\\Monopoly\\Chance cards.txt"); 
       Scanner in = new Scanner(n);
       int i=0;
       while(in.hasNextLine())
       {
         chances[i] = in.nextLine();
         pic[i] = new ImageView(new Image(new FileInputStream("C:\\Users\\misho\\OneDrive\\Desktop\\Monopoly\\L"+Integer.toString(i)+".jpg")));
