   ...
   static Scanner input = new Scanner(System.in);
    ...
    public static int wish(Alert alert,Property y, Player x, int indexofowner, Label info){
     ...
     public static Property[] assign(Property [] x){
         try{
       File n=new File("C:\\Users\\misho\\OneDrive\\Desktop\\Monopoly\\Property.txt"); 
     ...
     public static Station[] assign (Station [] x){
           try{
       File n=new File("C:\\Users\\misho\\OneDrive\\Desktop\\Monopoly\\Station.txt"); 
       Scanner in = new Scanner(n);
     ...
     public static void assign (double [] x,double [] y){
           try{
       File n=new File("C:\\Users\\misho\\OneDrive\\Desktop\\Monopoly\\xy.txt"); 
       Scanner in = new Scanner(n);
      for(int i =0; i<40; i++){
    ...
    v.getChildren().clear();v.getChildren().add( station[stationexist(player, station)].image());
     ...
     public static int getnumofplayers(int count){
       try ( ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\misho\\OneDrive\\Desktop\\Monopoly\\NumberofPlayers.bin"))) {
                 oos.write(count);
     ...
     public static void save(Player[]  x) throws IOException{
      try ( ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\misho\\OneDrive\\Desktop\\Monopoly\\Players.bin"))) {
     ...
     public static Player[] load(Player[] x) throws  ClassNotFoundException{
      ...
      try ( FileInputStream fis = new FileInputStream("C:\\Users\\misho\\OneDrive\\Desktop\\Monopoly\\Players.bin");
     ...
     public static int getnumber(){
          try ( ObjectInputStream os = new ObjectInputStream(new FileInputStream("C:\\Users\\misho\\OneDrive\\Desktop\\Monopoly\\NumberofPlayers.bin"))) {
